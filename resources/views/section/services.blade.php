        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title-box text-center">
                    <h3 class="title-heading mt-5 "> Pricing  </h3>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2 pt-4">
            <div class="col-lg-4">
                <div class="pricing-box mt-4">
                    <h4 class="f-20 text-center ">Starter</h4>
                    ...
                    <div class="pricing-plan mt-4 pt-2">
                        <h4 class="text-muted"> <span class="plan pl-3 text-dark">$8.99 </span></h4>
                        <p class="text-muted mb-0">/ mo</p>
                    </div>
